...
{
    public class TransferenciaBodegaCabModel : Event
    {
       ...
       // public virtual List<TransferenciaBodegaDetModel>? Productos { get; set; }
        ...
        public TransferenciaBodegaCabModel(string? codigo, string origen, int sucursal, int? sucursalD, string tipo, string tipoguia, string serie, bool remision, int numero, int bodega, int? numpedido, int? numguia, string? cliente, DateTime fechaemi, DateTime fechaven, DateTime? fechaent, int? bodegadestino, int? vendedor, int? proveedor, float? peso, float? volumen, string? motivo, string? observacion, string? comentario, string? seccontable, char estado, string? estadodoc, bool? enviadosri, string? numautorizacion, string? codigorel, DateTime fecha_ing, string maquina, int usuario, string direccionOrigen, string direcciondestino, int camion, int chofer)
        {
            Codigo = codigo;
            Origen = origen;
            Sucursal = sucursal;
