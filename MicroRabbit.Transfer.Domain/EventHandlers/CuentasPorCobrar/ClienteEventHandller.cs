        ...
        public Task Handle(ClienteCreateEvent @event)
        {
            if (@event.TipoPeticion == "POST")
            {
                var grabar = new ClientesTabla
                {
                    ...
                    PrecioAlCosto = @event.PrecioAlCosto == null ? false : @event.PrecioAlCosto,
                    PorcentajeIncremento = @event.PorcentajeIncremento == null ? 0 : @event.PorcentajeIncremento
                };
            ...
            if (@event.TipoPeticion == "PUT")
            {
                ...
                _clienteRepository.EditarTabla(grabar);
            }
